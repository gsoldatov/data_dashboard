...
- differentiate running DAGs from DAGs with a task scheduled for a retry;   // or change a color of "Running" DAG status in admin page
- allow adding new DAG versions into Airflow container without rebuilding it;
