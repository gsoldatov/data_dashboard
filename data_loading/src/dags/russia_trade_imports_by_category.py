...
from data_loading.src.tasks.russia_trade_imports_by_category.fetch_pages import (
    fetch_pages_task,
)
...
DAG_ID = "russia_trade_imports_by_category"
...
def russia_trade_imports_by_category_dag() -> None:
    config = get_config()

    fetch_pages_task(config) >> parse_pages_data_task(config)


russia_trade_imports_by_category = russia_trade_imports_by_category_dag()
